...
def prepare_mocks(mocker):
    mocker.patch('src.utils.filenames.create_pairs_dataset_directory_name', return_value=PAIRS_DATASET_DIRECTORY_NAME,
                 autospec=True)
    creating_dataset_mock = mocker.patch('src.data.pairing.creating_paired_data.create_paired_data', autospec=True,
